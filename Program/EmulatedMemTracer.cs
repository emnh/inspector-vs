...
namespace Program {
    ...
    public class EmulatedMemTracer {
        ...
        public static TraceState InstallTracer(Process process, ulong patchSite, Logger logger, ImportResolver ir, byte[] asmSizes, byte[] branches) {
